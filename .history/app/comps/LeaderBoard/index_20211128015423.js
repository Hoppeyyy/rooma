...
const LeaderBoard = ({
  ...
  return<CtrlCont display={display}>
      ...
      <ProfileCont >
          <SmallMembersProfile name="Hailey Kim" points="500pts"/>
      </ProfileCont >
      <ProfileCont >
          <SmallMembersProfile name="Chisaki Nakamura"/>
      </ProfileCont>
      <ProfileCont >
          <SmallMembersProfile name="Maria Monay"/>
      </ProfileCont>
      <ProfileCont>
          <SmallMembersProfile name="Leah Ma"/>
      </ProfileCont >
      <ProfileCont>
          <SmallMembersProfile name="Sean Luo"/>
      </ProfileCont>
